#class varibles in python
#class varibles will be common for all the class objects
...
print(Employee.__dict__)#now this will have the raise amount class variable listed in it
